...
# secreto = 'perfume'
# res = input("Digite uma letra para tentar advinhar qual e a
# palavra ou tente acertar de primeira: ")
#
# while True:
#     if res == 'perfume':
...
#         for re in secreto:
#             if re == res:
#                 print(f'{re}, essa letra esta na palavra, na posição
#  {contador}!!!')
#             if contador == 7:
#                 break
#             contador = contador + 1
#         break
#     res = input("Digite uma letra para tentar advinhar qual e a palavra ou
