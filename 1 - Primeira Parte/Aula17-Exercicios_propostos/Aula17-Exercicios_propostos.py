...
if horario.isdigit():
    ...
    print("Digite um horario que estava entre 0-23")


"""
Faça um programa que peça o primeiro nome do usuario. Se o nome tiver 4
letras ou menos escreva "Seu nome e curto"; se tiver entre 5 e 6 letras,
escreva "Seu nome é normal"; maior que 6 escreva "Seu nome e muito grande".
"""
