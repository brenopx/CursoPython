...
if __name__ == "__main__":
    ...
    camiseta2 = Product('camiseta1', 19.90)
    camiseta3 = Product('camiseta1', 29.90)
    ...
    # leaf
    smartphone1 = Product('smartphone1', 1149.90)
    smartphone2 = Product('smartphone1', 2230.90)
    ...
    # composite
    caixa_grande = Box('Caixa de Grande')
